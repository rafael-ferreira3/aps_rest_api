...
public class LoginEndpoint {
    ...
    public ResponseEntity<UsuarioQuery> loginUsuario(@RequestBody LoginParam loginParam){
    ...
    public ResponseEntity<ClienteQuery> loginCliente(@RequestBody LoginParam loginParam){
